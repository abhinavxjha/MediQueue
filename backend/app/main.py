...
from .routers import auth, patient, doctor, queue, admin, analytics, slips, profile, hospital
...
for r in [auth.router, patient.router, doctor.router, queue.router, admin.router, analytics.router, slips.router, profile.router, hospital.router]:
