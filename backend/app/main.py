...
from .routers import auth,patient,doctor,queue,admin,analytics,slips,profile
...
for r in [auth.router,patient.router,doctor.router,queue.router,admin.router,analytics.router,slips.router,profile.router]: app.include_router(r)
@app.get('/')
